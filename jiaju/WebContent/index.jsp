						...
						<ul class="nav navbar-nav">
								...
								<ul class="dropdown-menu multi-column columns-3">
									<div class="row">
										<div id="div" class="col-sm-4" style="width:100px;">
											<ul class="multi-column-dropdown" id="style" value="所有">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu multi-column columns-3">
									<div class="row">
										<div id="div" class="col-sm-4" style="width:100px;">
											<ul class="multi-column-dropdown" id="function1" value="所有">
												<li><a value="所有" href="#">所有</a></li>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu multi-column columns-3">
									<div class="row">
										<div  id="div" class="col-sm-4" style="width:100px;">
											<ul class="multi-column-dropdown" id="material" value="所有">
												<li><a value="所有" href="#">所有</a></li>
					...
					<div class="search-box">
						<div id="sb-search" class="sb-search" style="width:300px;">
							<form action="${pageContext.request.contextPath}/searchproduct" method="post" enctype="mutipart/form-data">
								<input name="pname" class="sb-search-input" placeholder="Enter your search iterm..." type="text" id="search" />
