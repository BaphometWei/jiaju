...
<body>
						...
						<li>
							...
							<div id="subPages" class="collapse in">
								<ul class="nav">
									...
									<li><a href="${pageContext.request.contextPath}/shouhouorder" class="active">申请售后订单</a></li>
		...
		<div class="main">
			...
			<c:forEach items="${os}" var="o" varStatus="st">
            	<tr>
                    ...
                    <td style="text-align: center">${o.reason}</td>
                    <td style="text-align: center"><div value="${o.oid}" value1="${o.uid}" class="glyphicon glyphicon-ok" style="text-align: center;cursor:pointer;"></div></td>
                	<td style="text-align: center"><div value="${o.oid}" value1="${o.uid}" class="glyphicon glyphicon-check" style="text-align: center;cursor:pointer;"></div></td>
                </tr>
            </c:forEach>
						</tbody>
					</table>
	...
	$(".glyphicon-check").on('click', function(){
		var oid=$(this).attr("value");
		$.ajax({
			url:"${pageContext.request.contextPath}/agreeshouhou?oid="+oid,
			type:"GET",
			dataType:'text',
			success:function(data){
				if(data==1)
