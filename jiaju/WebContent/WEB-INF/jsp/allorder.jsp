	...
	<div id="wrapper">
					...
					<ul class="nav">
						...
						<li>
							...
							<div id="subPages" class="collapse in">
								<ul class="nav">
									<li><a href="${pageContext.request.contextPath}/allorder" class="active">全部订单</a></li>
		...
		<div class="main">
			...
			<c:forEach items="${os}" var="o" varStatus="st">
				...
				<div id="detail" style="margin-top:3px;margin-right: 3px;box-shadow:0px 0px 5px #fff;">
							<!-- TABLE HOVER -->
							<div class="panel">
